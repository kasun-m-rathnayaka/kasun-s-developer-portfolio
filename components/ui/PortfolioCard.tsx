...
function KeyFeaturesCard({ features }: { features: string[] }) {
  ...
  function ChallengesAndSolutionsCard({ challenges, solutions }: { challenges: string, solutions: string }) {
    return (
      <Card>
        <CardHeader>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <ChallengesAndSolutionsCard challenges={project.challenges} solutions={project.solutions} />
      </div>
